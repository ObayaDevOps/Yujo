...
export default function ContactFormWithSocialButtons() {
  const { hasCopiedEmail, onCopyEmail } = useClipboard('obayadevops@gmail.com');
  const { hasCopiedPhone, onCopyPhone } = useClipboard('+2560789062116');
  const { hasCopiedWA, onCopyWA } = useClipboard('+2560789062116');
...
<Head>
      <title>Contact Us | Dralega Web Operations Ltd</title>
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            <Stack
              ...
              <Stack
                ...
                <Tooltip
                  label={hasCopiedEmail ? 'Email Copied!' : 'Copy Email - obayadevops@gmail.com'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="email"
                ...
                <Tooltip
                  label={hasCopiedPhone ? 'Number Copied!' : 'Copy Number  - +256 789 062116'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="phone"
                ...
                <Tooltip
                  label={hasCopiedWA ? 'Number Copied!' : 'Copy Whats App  - +256 789 062116'}
                  closeOnClick={false}
                  hasArrow>
                  <IconButton
                    aria-label="whatsapp"
                ...
                <Link href="https://www.linkedin.com/in/obaya-dralega/">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
